            ...
            <div className='row'>
              <div className='col-lg-6'>
                <div className='about-thumb-wrap'>
                  ...
                  <img
                    className='img-2'
                    src='./assets/img/about/a5.jpg'
                    alt='Transpro'
                  />
                  {/* <img
                    className='img-3'
                    src='./assets/img/about/a3.jpg'
                    alt='Transpro'
                  /> */}
              ...
              <div className='col-lg-6 align-self-center'>
                <div className='about-inner-wrap'>
                  <div className='section-title mb-0'>
                    ...
                    A leading brokerage firm based in the USA, committed to connecting businesses with reliable transportation solutions
                    </p>
                    <div className='row'>
                      ...
                      <div className='col-xl-6 col-lg-12 col-md-6 align-self-center'>
                        <div className='thumb'>
                          <img src='./assets/img/about/a2.jpg' alt='Transpro' />
                        </div>
                      </div>
                    </div>
                    <div className='btn-wrap'>
                      ...
                      <div className='author-wrap'>
                        <div className='thumb'>
                          <img src='./assets/img/about/a1.jpg' alt='Transpro' 
                          height={50}
